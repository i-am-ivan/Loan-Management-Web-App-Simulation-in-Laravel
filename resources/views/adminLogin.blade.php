            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <form class="pt-3" action="{{ route('admin.dashboard') }}">
                  ...
                  <div class="text-center mt-4 fw-light"> Don't have an account? <a href="register.html" class="text-primary">Contact System Administrator</a>
                  </div>
                </form>
              </div>
            </div>
