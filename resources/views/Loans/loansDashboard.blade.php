                ...
                <div class="tab-content tab-content-basic">
                            ...
                            <div class="card bg-primary card-rounded">
                                ...
                                <div class="row">
                                    ...
                                    <div class="status-summary-chart-wrapper pb-4">
                                        <canvas id="status-summary" style="display: block; box-sizing: border-box; height: 66px; width: 167px;" width="167" height="66"></canvas>
                                    </div>
                                    </div>
                                </div>
                                </div>
                        ...
                        <div class="row flex-grow">
                            ...
                            <div class="card card-rounded">
                                ...
                                <div class="d-sm-flex justify-content-between align-items-start">
                                    ...
                                    <div id="performanceLine-legend"><ul>
                    <li>
                    ...
                    Last week
                                ...
                                <div class="chartjs-wrapper mt-4">
                                    <canvas id="performanceLine" style="display: block; box-sizing: border-box; height: 150px; width: 609px;" width="609" height="150"></canvas>
                                </div>
                                </div>
                            </div>
                            </div>
                    ...
                    This week
                                ...
                                <div class="chartjs-bar-wrapper mt-3">
                                    <canvas id="marketingOverview" style="display: block; box-sizing: border-box; height: 150px; width: 609px;" width="609" height="150"></canvas>
                                </div>
                                </div>
                            </div>
                            </div>
                        ...
                        <div class="row flex-grow">
                            ...
                            <div class="card card-rounded">
                                ...
                                <div class="row">
                                    ...
                                    <canvas class="my-auto" id="doughnutChart" height="265" style="display: block; box-sizing: border-box; height: 265px; width: 265px;" width="265"></canvas>
                                    <div id="doughnutChart-legend" class="mt-5 text-center"><ul>
                    <li>
                    <span style="background-color: #1F3BB3"></span>
                    Total
                    </li>
                        ...
                        <div class="row flex-grow">
                            ...
                            <div class="card card-rounded">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mt-3">
                                        <canvas id="leaveReport" style="display: block; box-sizing: border-box; height: 150px; width: 265px;" width="265" height="150"></canvas>
                                    </div>
                                    </div>
                                </div>
                                </div>
