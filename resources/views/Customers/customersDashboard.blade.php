        ...
        <div class="navbar-menu-wrapper d-flex align-items-top">
          <ul class="navbar-nav">
            <li class="nav-item fw-semibold d-none d-lg-block ms-0">
              <h1 class="welcome-text"><span class="text-black fw-bold">{{ $heading }}</span> Insights and Management</h1>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{ route('loans.loan-types') }}">Loan Products</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('loans.customer-loans') }}">Customer Loan</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('loans.loan-types') }}">Loan Stats</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="form-elements">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"><a class="nav-link" href="{{ route('customers.customers-dashboard') }}">Customer Administration</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
